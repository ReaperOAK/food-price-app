...
const InternationalSEO = memo(({ userCountry, selectedCity, selectedState, todayRate }) => {
  ...
  const getLocalizedContent = () => {
    ...
    return {
      ...
      keywords: [
        `indian egg prices ${userCountry.toLowerCase()}`,
        `necc rates for nri ${userCountry.toLowerCase()}`,
        `indian food prices in ${userCountry.toLowerCase()}`,
        `egg rates india to ${currency.toLowerCase()}`,
        `indian market rates ${userCountry.toLowerCase()}`,
