      ...
      <div className="container mx-auto w-full max-w-7xl relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          <div className="space-y-4">
            <h2 className="text-2xl font-bold text-white mb-4">Today Egg Rates</h2>
            <p className="text-gray-200 text-base sm:text-sm leading-relaxed max-w-xs">
            ...
            <div className="text-gray-200 space-y-3">
              <p className="flex items-center transition-colors duration-300 text-base sm:text-sm">
                ...
                <a 
                  ...
                  className="hover:text-white focus:outline-none focus:ring-2 focus:ring-orange-200 rounded-sm px-1"
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 text-sm">
          ...
          <p className="text-gray-200 flex items-center space-x-1 text-sm">
            <span>Made with</span>
            <span className="text-red-400 mx-1" role="img" aria-label="love">♥</span>
            <span>by</span>
            <FooterLink 
