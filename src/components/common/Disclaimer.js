...
const DisclaimerSection = memo(({ title, children }) => (
  <section className="mb-8 bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300">
    ...
    <div className="bg-gray-50 min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-6 max-w-4xl">
        ...
        <div className="space-y-6">
          <DisclaimerSection title="Information Accuracy">
          ...
          <DisclaimerSection title="Liability and Responsibility">
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-700 leading-relaxed mb-4">
          ...
          <DisclaimerSection title="Data Sources">
            <div className="prose prose-gray max-w-none">
              <p className="text-gray-700 leading-relaxed">
