...
const EggRates = () => {
  ...
  return (
    <div>
      ...
      <img src="/desiegg.webp" alt="Egg Rates Banner" className="w-full mb-8 rounded-lg shadow-md" />
      ...
      <section className="mb-8">
        ...
        <img src="/eggpic.webp" alt="Egg Price Chart" className="w-full mb-8 rounded-lg shadow-md" />
      </section>
